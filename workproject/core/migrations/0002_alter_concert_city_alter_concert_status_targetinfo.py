...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name="status",
            field=models.CharField(
                choices=[("Идет", "Идет"), ("Прошел", "Прошел")],
                max_length=10,
                verbose_name="Статус Концерта",
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "targetAccountID",
                    models.CharField(
                        max_length=10, verbose_name="ID Личного кабинета клиента"
                    ),
                ),
                (
                    "targetCompanyID",
                    models.CharField(max_length=10, verbose_name="ID Концерта"),
                ),
                (
                    "cat",
                    models.ForeignKey(
